  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    if (student == null) {
      ...
      out.printf("  <td><select name='degree'>"
          + "<option value='0' %s>고졸</option>"
          + "<option value='1' %s>전문학사</option>"
          + "<option value='2' %s>학사</option>"
          + "<option value='3' %s>석사</option>"
          + "<option value='4' %s>박사</option>"
          + "<option value='5' %s>기타</option>"
          + "</select></td>\n"
          , student.getDegree() == 0 ? "selected" : ""
            , student.getDegree() == 1 ? "selected" : ""
              , student.getDegree() == 2 ? "selected" : ""
                , student.getDegree() == 3 ? "selected" : ""
                  , student.getDegree() == 4 ? "selected" : ""
                    , student.getDegree() == 5 ? "selected" : "");
      out.println("</tr>");
      ...
      out.println("<tr>");
      out.println("  <th>강의료</th>");
      out.printf("  <td><input type='tel' name='wage' value='%s'></td>\n",  student.getWage());
      out.println("</tr>");
