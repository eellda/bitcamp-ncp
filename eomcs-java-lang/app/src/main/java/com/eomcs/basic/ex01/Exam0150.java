...
public class Exam0150 {
  ...
  public static void main(String[] args) {
    ...
    // => Set 이기 때문에 집합 방식으로 목록을 다룬다. 즉, 중복 값을 저장하지 않는다.
    // => 저장할 객체에 대해 hash 코드로 중복 여부를 검사한다.
    // => 저장 과정:
    // 1) equals()와 hashCode()를 호출하여 같은 중복 여부를 검사한다.
    // 2) equals()의 리턴값도 true이고 hashCode()의 리턴 값도 같은 경우,
    //    같은 객체로 판단하여 저장하지 않는다.
    // 3) 단, 저장위치는 hashCode()의 리턴 값을 사용하여 계산함.
